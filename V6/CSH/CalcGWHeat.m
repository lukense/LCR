...
%         cd('C:\Users\Eileen\Neilson Research Dropbox\Eileen Lukens\LCR\Temperature Model\LCR_Model\SWMM6 - PreStorm\V3\CSH\GWHeat\GW_heat_watts_per_meter_in');
%         %% writing tables
%         filename1 = [erase(k(i).name,".dat"),'_heat_in_watts_per_meter.csv'];
%         writetable(Table_Heat,filename1,'Delimiter',',')
% 
%         %% set export directory
%         cd('C:\Users\Eileen\Neilson Research Dropbox\Eileen Lukens\LCR\Temperature Model\LCR_Model\SWMM6 - PreStorm\V3\CSH\GWHeat\GW_outflows_CMS_per_meter');
%         %% writing tables
